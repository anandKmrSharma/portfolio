export const projects = [
  {
    ...
    description:
      "Smallcase is the website where users can buy stock.Replication of Smallcase website along with authentication feature, where users can filter, see the details and invest in stocks.",
    image: "/images/1.png",
