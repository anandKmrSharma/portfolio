export const projects = [
  {
    ...
    description:
      "Smallcase is the website where users can buy stock.clone of Smallcase website along with authentication feature, users can filter, see the details and invest in stocks.",
    image: "/images/1.png",
